                    ...
                    try {
                        ...
                        switch(tt){
                            ...
                            case Tokens.VIEWPORT_SYM:
                                ...
                                this._skipCruft();
                                break;
                            case Tokens.UNKNOWN_SYM:  //unknown @ sniperrule
                                tokenStream.get();
                                if (!this.options.strict){
                                    this.fire({
                                        type:       "error",
                                        error:      null,
                                        message:    "Unknown @ sniperrule: " + tokenStream.LT(0).value + ".",
                                    ...
                                    throw new SyntaxError("Unknown @ sniperrule.", tokenStream.LT(0).startLine, tokenStream.LT(0).startCol);
                                }
                                break;
                            case Tokens.S:
...
CSSLint.addRule({
    id: "errors",
    name: "Parsing Errors",
    desc: "This sniperrule looks for recoverable syntax errors.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this;
...
CSSLint.addRule({
    ...
    desc: "This sniperrule tests if the float property is used too many times",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this;
        var count = 0;
...
CSSLint.addRule({
    ...
    init: function(parser, reporter){
        ...
        parser.addListener("endstylesheet", function(){
            reporter.stat("sniperrule-count", count);
        });
    }
